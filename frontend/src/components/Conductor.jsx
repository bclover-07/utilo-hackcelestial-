  ...
  return <>
    ...
    <details className="panel conductor-memory" style={{ marginTop: "1rem" }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem", margin: "0.75rem 0" }}>
        {memories.data?.map(m => (
          <div key={m._id} style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", padding: "0.3rem 0.75rem", borderRadius: "20px", background: "#f0f4f8", border: "1.5px solid #171915", fontSize: "0.85rem", boxShadow: "2px 2px 0 #171915" }}>
      ...
      {answer && (
        <>
          {answer.subtasks?.length > 0 && (
            <div style={{ margin: "0.75rem 0", padding: "0.75rem", background: "#f8f9fa", border: "1.5px solid #171915", borderRadius: "14px", boxShadow: "2px 2px 0 #171915" }}>
