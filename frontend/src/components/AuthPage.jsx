    ...
    <main className="auth-studio">
      ...
      <div className="auth-layout">
        ...
        <section className="panel auth-card">
          ...
          {!register && (
            <div style={{ margin: "0.75rem 0 1rem", padding: "0.75rem", background: "#F5F2EB", borderRadius: "14px", border: "1.5px solid #171915", boxShadow: "2px 2px 0 #171915" }}>
              <span className="eyebrow" style={{ fontSize: "0.7rem", letterSpacing: "0.08em", display: "block", marginBottom: "8px", fontWeight: 800 }}>
